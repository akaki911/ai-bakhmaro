...
const DEVELOPER_PROMPT =
  getPromptTemplate('developer_prompt') || PROMPT_TEMPLATES.developerPrompt;
...
const BASE_PERSONA_CORE = SYSTEM_PROMPT_GURULO;
...
const SYSTEM_PROMPT_BUILDERS = {
  base: () => [
    ...
    "- თუ საკმარისი ინფორმაცია არ გაქვს, თავაზიანად ახსენე რომ მონაცემი არ არის და სთხოვე დამატება; არ გამოიგონო პასუხები;",
    "- მიღებული სნიპეტები/ცოდნა ყოველთვის ციტირებით მიუთითე, რომ წყარო გამოკვეთილი იყოს;",
  ...
  memoryAware: () => [
    ...
    "- თუ საკმარისი ინფორმაცია არ გაქვს, თავაზიანად ახსენე რომ მონაცემი არ არის და სთხოვე დამატება; არ გამოიგონო პასუხები;",
    "- მიღებული სნიპეტები ან კონტექსტი აუცილებლად მოყოლდეს ციტირებით, რათა წყარო იყოს იდენტიფიცირებული;",
  ...
  codeAssistant: () => [
    ...
    "**Safety & Sources:**",
    "- თუ საკმარისი ინფორმაცია არ გაქვს, თავაზიანად ახსენე რომ მონაცემი არ არის და სთხოვე დამატება; არ გამოიგონო პასუხები;",
    "- ყველა მიღებულ კოდის ფრაგმენტს ან ცოდნას თან ახლდეს ციტირება/წყაროს მითითება, რათა მომხმარებელმა გადაამოწმოს;",
    "",
    "**Response Format:**",
