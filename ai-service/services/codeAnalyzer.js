...
class CodeAnalyzer {
  ...
  async createThematicSummary(moduleAnalysis) {
    let summary = "🏗️ Gurulo AI Developer Space თემატური ანალიზი:\n\n";
...
${structuredSummary}`;
  ...
  generateFallbackThematicResponse(structuredSummary) {
    return `🏗️ Gurulo AI Developer Space თემატური შეჯამება:
...
📊 **ფუნქციონალი:**
• AI Developer Panel და Explorer
• Auto-Improve და rollout კონტროლი
• Memory სისტემა და კონტექსტის მენეჯმენტი
• უსაფრთხოების აუდიტი და WebAuthn
• AI მხარდაჭერა DevOps ოპერაციებისთვის`;
  }
