...
export const SentIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
...
export const SparkleIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
        <path d="M12 2L14.39 8.36L21 9.61L16.42 14.2L17.61 21L12 17.77L6.39 21L7.58 14.2L3 9.61L9.61 8.36L12 2z" />
        <path d="M5 3v4" />
        <path d="M19 17v4" />
        <path d="M3 5h4" />
        <path d="M17 19h4" />
...
export const MoveIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
        <polyline points="5 9 2 9 2 5"></polyline><polyline points="19 15 22 15 22 19"></polyline><polyline points="15 19 15 22 19 22"></polyline><polyline points="9 5 9 2 5 2"></polyline><line x1="2" y1="12" x2="22" y2="12"></line><line x1="12" y1="2" x2="12" y2="22"></line>
    </svg>
);
...
export const MailOpenIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
        <path d="M22 12.25V20a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V8l8-4 8 4v4.25"></path>
        <path d="M14 10.5L2 8"></path>
        <path d="M22 8l-8 2.5"></path>
        <path d="M12.49 19.49L7.5 14.5"></path>
        <path d="M16.5 14.5L11.5 19.5"></path>
    </svg>
);
...
export const EmptyInboxIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
