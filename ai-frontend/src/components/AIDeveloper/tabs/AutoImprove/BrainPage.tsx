...
import StatusStrip from '../../AutoImprove/Brain/StatusStrip';
import ThinkingNow from '../../AutoImprove/Brain/ThinkingNow';
import LastOutcome from '../../AutoImprove/Brain/LastOutcome';
import NextAction from '../../AutoImprove/Brain/NextAction';
import LiveFeed from '../../AutoImprove/Brain/LiveFeed';
import Metrics from '../../AutoImprove/Brain/Metrics';
import Controls from '../../AutoImprove/Brain/Controls';
import History from '../../AutoImprove/Brain/History';
import type {
  ActionEventPayload,
  BrainEventRecord,
  BrainHistoryEntry,
