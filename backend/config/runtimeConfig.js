...
const { resolveFirebaseServiceAccount } = require('@ouranos/shared/secretResolver');
const { describeInternalToken } = require('@ouranos/shared/internalToken');
const { normalizeNodeEnv } = require('@ouranos/shared/config/envReader');
