...
const CORE_DEVELOPER_PROMPT =
  getBackendPromptTemplate('developer_prompt') || BACKEND_PROMPT_TEMPLATES.developerPrompt;
...
3. შემდეგ რა უნდა შევამოწმოთ`
  ...
  getPrompt(queryType, additionalData = {}) {
    ...
    return {
      ...
      developer: promptConfig.developer || CORE_DEVELOPER_PROMPT,
  ...
  optimizeForTokens(promptData, maxTokens = 150) {
    ...
    return {
      ...promptData,
      developer: promptData.developer || CORE_DEVELOPER_PROMPT,
    };
  }
